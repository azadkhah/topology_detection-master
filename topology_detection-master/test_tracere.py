...
# from .utils import *
from icmplib import is_hostname, resolve, is_ipv6_address, ICMPv6Socket, ICMPv4Socket, ICMPRequest, Hop
    ...
    with _Socket(source) as sock:
        while not host_reached and ttl <= max_hops:
            ...
            for sequence in range(count):
                logging.info(str(ttl)+"   "+str(address)+"   "+str(sequence)+"   "+str(id))
